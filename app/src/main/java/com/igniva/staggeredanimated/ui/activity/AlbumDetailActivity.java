...
public class AlbumDetailActivity extends AppCompatActivity {
    ...
    ImageView mIvImage;
    TextView mTvName;
    String LOG_TAG = "AlbumDetailActivity";/**/
...
//
    ...
    private List<ItemObjects> getListItemData() {
        ...
        GallaryItemPojo gallaryItemPojo = new GallaryItemPojo();
    ...
    public ArrayList<ItemObjects> getAlbumItemListData(String album_id) {
        RecorderDatabase recoder = new RecorderDatabase(AlbumDetailActivity.this);
